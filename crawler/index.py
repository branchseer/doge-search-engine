...
def crawl(url, depth=0, urlfilter=lambda url: True, maxDepth=float("infinity"), linkset=set()):
  content = None
  try:
...
if __name__ == '__main__':
    ...
    base_path = 'pages'
    for url, content, links in crawl('http://www.seu.edu.cn/s/132/main.jspy', urlfilter=filter):
      print(url)
